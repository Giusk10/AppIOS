                    ...
                    VStack(spacing: 20) {
                        ZStack {
                            Circle()
                                .fill(
                                    LinearGradient(
                                        colors: [Color.spendyPrimary.opacity(0.2), Color.spendyAccent.opacity(0.1)],
                        ...
                        VStack(spacing: 8) {
                            ...
                            Text(isLoginMode ? "Accedi per gestire le tue spese" : "Registrati per iniziare")
                                .font(.body)
...
struct ModernTextField: View {
    ...
    var body: some View {
        ...
        .shadow(color: isFocused ? Color.spendyPrimary.opacity(0.15) : Color.black.opacity(0.04), radius: isFocused ? 8 : 4, x: 0, y: 2)
